...
public class CalcLevel implements ActionListener, iCharacter
{
    ...
    private int currentLevel = 0, originalLevel = 0;
    private static int  hp, hpRec, spMp;
    ...
    private void calculateLevel()
    {
        ...
        switch(className)
        {
            ...
            default:
            {
                StatsTab.getSystemTextArea().append(FileIO.getCalcLevelMessages().get(0) + className + "\n\n");
            }
        }
    }
