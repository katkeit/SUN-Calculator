...
public class StatsTab
{
    ...
    private static JTextField tfSTR = new JTextField();
    private static JTextField tfAGI = new JTextField();
    private static JTextField tfVIT = new JTextField();
    private static JTextField tfINT = new JTextField();
    private static JTextField tfSPI = new JTextField();
    private static JLabel lblSTR = new JLabel();
    private static JLabel lblAGI = new JLabel();
    private static JLabel lblVIT = new JLabel();
    private static JLabel lblINT = new JLabel();
    private static JLabel lblSPI = new JLabel();
    ...
    // ------------ Add Stats Panel ------------
    private static final JPanel addStatsPanel = new JPanel();
    private static TitledBorder addStatBorder;
    private static final JLabel sd = new JLabel();
    private static final JLabel sdValue = new JLabel();
    private static final JLabel hp = new JLabel();
    private static final JLabel hpValue = new JLabel();
    private static final JLabel hpRecoveryValue = new JLabel();
    private static final JLabel spMp = new JLabel();
    private static final JLabel spMPValue = new JLabel();
    private static final JLabel spMpRecoveryValue = new JLabel();
    private static final JLabel basicDamage = new JLabel();
    private static final JLabel basicDamageLowValue = new JLabel();
    private static final JLabel basicDamageHighValue = new JLabel();
    private static final JLabel addBasicDamageValue = new JLabel();
    private static final JLabel defense = new JLabel();
    private static final JLabel defenseValue = new JLabel();
    private static final JLabel addDefenseValue = new JLabel();
    private static final JLabel defenseSuccess = new JLabel();
    private static final JLabel defenseSuccessValue = new JLabel();
    private static final JLabel attackSuccess = new JLabel();
    private static final JLabel attackSuccessValue = new JLabel();
    private static final JLabel attackSpeed = new JLabel();
    private static final JLabel attackSpeedValue = new JLabel();
    private static final JLabel critChance = new JLabel();
    private static final JLabel critChanceValue = new JLabel();
    private static final JLabel skillEnh = new JLabel();
    private static final JLabel skillEnhValue = new JLabel();
    private static final JLabel incDebuffTime = new JLabel();
    private static final JLabel incDebuffTimeValue = new JLabel();
    private static final JLabel seconds = new JLabel();
    private static final JLabel plus1 = new JLabel();
    private static final JLabel plus2 = new JLabel();
    private static final JLabel plus3 = new JLabel();
    private static final JLabel plus4 = new JLabel();
    private static final JLabel tilde = new JLabel();
    private static final JLabel percent1 = new JLabel();
    private static final JLabel percent2 = new JLabel();
    private static final JLabel percent3 = new JLabel();

    // ---------- Con Add Stats Panel ----------
    private static final JPanel conAddPanel = new JPanel();
    private static final JPanel buffDebuffPanel = new JPanel();
    private static TitledBorder conAddBorder;
    private static TitledBorder buffDebuffBorder;
    private static JLabel incBuffTime;
    private static JLabel infDamDebuffTime;
    private static JLabel redTargetDefense;
