...
public class Preference implements ActionListener
{
    ...
    private static TitledBorder preferences = new TitledBorder(""), language = new TitledBorder(""),
            themes = new TitledBorder("");
    private static JPanel preferencePanel = new JPanel(), langPanel = new JPanel(), themePanel = new JPanel();
    private static ButtonGroup langGroup = new ButtonGroup(), themeGroup = new ButtonGroup();
    private static JRadioButton english = new JRadioButton(""), spanish = new JRadioButton(""),
            portuguese = new JRadioButton(""), lightTheme = new JRadioButton(), darkTheme = new JRadioButton("");
